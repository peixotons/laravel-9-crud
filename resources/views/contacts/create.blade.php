    ...
    <div class="container">
        <div class="container-form">
            <div class="form">
                ...
                <form id="createcontact" class="row g-3" action="{{ route('contacts.store') }}" method="post">
                    @csrf
                    <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input name="address" type="text" class="form-control @error('address') is-invalid @enderror"
                            id="address" placeholder="1234 Main St" data-input>
                        @error('address')
                            <p class="alert alert-danger mt-2 p-2 error">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <input name="city" type="text" class="form-control @error('city') is-invalid @enderror"
                            id="city" placeholder="City" data-input>
                        @error('city')
                            <p class="alert alert-danger mt-2 p-2 error">{{ $message }}</p>
                        @enderror
                    </div>
